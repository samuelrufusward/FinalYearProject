...
from metrics.calculate_recon_error import *
from sklearn.random_projection import johnson_lindenstrauss_min_dim
import pandas as pd
from scipy.spatial import distance_matrix
from scipy.stats import pearsonr, spearmanr
from metrics.visualize_matrix import *
from metrics.visualize_sample_reconstruction import *
from metrics.coranking_matrix import *
from metrics.plt2base64 import *
import json
import os
import csv
...
class DRMetrics:
    ...
    def __init__(self, X, Z, Xr = None):
        ...
        self.D_df = pd.DataFrame(distance_matrix(df.values, df.values))
        self.D = self.D_df.values

        dfz = pd.DataFrame(Z, index=None)
        self.Dz_df = pd.DataFrame(distance_matrix(dfz.values, dfz.values))
        self.Dz = self.Dz_df.values
        ...
        self.R = ranking_matrix(self.D_df)
        self.Rz = ranking_matrix(self.Dz_df)
